...
class TestDivSet:
    ...
    def test__get_div_set__3p4tm1_1_m1( self ):
        ...
        chk_lst = ['h-e1-e2', 'h-e1-e3', 'h-e2-e3', 'h-e1-e4', 'h-e2-e4', 'h-e3-e4']
        out_lst = []
        d = Div( [3] + 4 * [-1] )
    ...
    def test__get_div_set__3p8tm1_1_m1( self ):
        ...
        chk_lst = [ 'h-e1-e2',
                    ...
                    '6h-3e1-2e2-2e3-2e4-2e5-2e6-2e7-2e8' ]
        out_lst = []
        d = Div( [3] + 8 * [-1] )
    ...
    def test__get_m1_classes__4_True( self ):
        NSTools.set_enable_tool_dct( False )
        chk_lst = ['e3', 'e2', 'e1', 'h-e1-e2', 'h-e1-e3', 'h-e2-e3']
        out_lst = []
    ...
    def test__get_m1_classes__5_True( self ):
        NSTools.set_enable_tool_dct( False )
        chk_lst = ['e4', 'e3', 'e2', 'e1', 'h-e1-e2', 'h-e1-e3',
                   'h-e2-e3', 'h-e1-e4', 'h-e2-e4', 'h-e3-e4']
        out_lst = []
